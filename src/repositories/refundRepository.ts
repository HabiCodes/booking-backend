...
export class RefundRepository {
  async create(input: RefundCreateInput): Promise<RefundRow> {
  ...
  async updateStatus(id: number, status: RefundStatus, extra: Record<string, unknown> = {}): Promise<RefundRow | null> {
