...
class FinancialLedgerService {
    ...
    async postPromotionRevenue(params) {
        ...
        try {
            ...
            await client.query('COMMIT');
            logger_1.logger.info('Promotion revenue posted to ledger', {
                referenceId: params.reference_id,
                amountPaise: params.amount_paise,
            });
        }
            ...
            if (err.code === '23505') {
                logger_1.logger.info('Promotion revenue already posted (idempotent)', { referenceId: params.reference_id });
                return;
            }
            throw err;
        }
